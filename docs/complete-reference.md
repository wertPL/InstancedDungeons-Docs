...
Item restrictions are available in every edition:
...
All values default to `false`. See [Dungeon Config](configuration.md#item-restrictions) for the behavior controlled by each field.
